...
namespace Scoreboard.ViewModels {
    ...
    public class MainWindowViewModel: ViewModelBase {
        ...
        private void SetButtonState(int num, bool state) {
            ...
            var app = Application.Current ?? throw new System.Exception("What?");
            var ress = app.Resources;

            var res = ress[num == 0 ? (state ? "vilet2" : "vilet1") : (state ? "prilet2" : "prilet1")];
            var img2 = (Image) (res ?? throw new System.Exception("What?"));
